...
def hello():
    return 'I am Top Helper Bot. How can I help you?'
...
def add_email(data):
    ...
    return f'Email {email} for {name} was added'
...
def main():
    print('Please enter one of the commands from the command dictionary.')
